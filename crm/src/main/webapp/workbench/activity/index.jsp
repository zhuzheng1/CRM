						...
						*/
						...
						/*
							注意：
								...
								但是表当的jQuery对象，没有为我们提供reset方法让我们重置表单
				...
				<div class="modal-body">
					...
					<form id="activityUpdateForm" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<!-- 
								关于textarea：
									（1）一定是要以标签对的形式来呈现，正常下标签对要紧紧挨着
									（2）这个标签虽然是以标签对的形式来呈现的，但是它也是属于表单元素范畴
										我们所有的对于textarea的取值与复制操作应该统一使用val（）方法
										而不是html（）方法
							 -->

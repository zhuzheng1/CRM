...
<script type="text/javascript">
	$(function(){
		...
		//为提交按钮绑定事件源，填充市场活动源（填两项信息  名字+id）
		...
		$("#convertBtn").click(function(){
			...
			/* 
				...
				根据“为客户创建交易的勾有没有选择，来判断是否需要创建交易”
			*/
			
			if($("#isCreateTransaction").prop("checked")) {
				
				/* 
					如果需要创建交易，除了要为后台传递clueId之外，还得为后台传递交易表单中的信息，金额，
					预计成交日期，交易名称，阶段，市场活动源
				*/
				
				//window.location.href = "workbench/clue/convert.do?clueId=${param.id}&money=xxx....";
...
<!-- 							</tr> -->
	...
	<!-- 
		提交表单行为结果，
			workbench/clue/convert.do?money=xxxx&name=xxxx......
	 -->

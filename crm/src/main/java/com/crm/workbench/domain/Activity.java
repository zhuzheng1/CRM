...
public class Activity {
	...
	public Activity(String id, String owner, String name, String startDate,
			String endDate, String cost, String description, String createTime,
			String createBy, String editTime, String editBy) {
		super();
		this.id = id;
		this.owner = owner;
		this.name = name;
	...
	public String toString() {
		return "Activity [id=" + id + ", owner=" + owner + ", name=" + name
